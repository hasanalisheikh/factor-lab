...
const createRunSchema = baseRunConfigSchema
  .extend({
...
function findReusableBatchId(symbols: string[], activeJobs: ActiveIngestJobRow[]): string | null {
...
async function getTickerStatsSnapshot(
  symbols: string[]
