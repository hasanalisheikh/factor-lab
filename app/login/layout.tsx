...
export default function LoginLayout({
  ...
  return (
    <main className="relative isolate min-h-screen overflow-hidden bg-background px-4 py-4 sm:px-6 sm:py-6 lg:px-10">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl items-start justify-center pt-5 sm:pt-8 lg:pt-[15vh]">
        {children}
      </div>
    </main>
  )
