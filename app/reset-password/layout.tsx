...
export const metadata: Metadata = {
  title: "Reset Password | FactorLab",
}
...
export default function ResetPasswordLayout({
  ...
  return (
    <main className="relative isolate flex min-h-dvh items-center justify-center overflow-hidden bg-background px-4 py-8 sm:px-6 lg:px-10">
