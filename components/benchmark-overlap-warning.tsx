      ...
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              type="button"
              className="inline-flex shrink-0 items-center gap-1 text-amber-200 underline underline-offset-2"
            >
          ...
          <TooltipContent sideOffset={8} className="max-w-xs">
            When a strategy holds the same asset used as its benchmark, part of the portfolio{" "}
            <em>is</em> the benchmark. This can understate or overstate relative performance deltas
            (e.g. CAGR vs {benchmark}), since the strategy is partially tracking itself against the
            benchmark.
          </TooltipContent>
        </Tooltip>
      </div>
