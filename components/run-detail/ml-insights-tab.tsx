      ...
      <Card className="bg-card border-border">
        <CardContent className="px-4 py-3">
          <p className="text-[12px] text-muted-foreground leading-relaxed">
            <span className="font-medium text-card-foreground">How it works: </span>
            ...
            {topN !== null ? (
              <span className="font-medium text-card-foreground">top {topN}</span>
            ) : (
              "top N"
            )}{" "}
            ...
            <span className="font-medium text-card-foreground">Feature Importance</span> chart below
                    ...
                    content={({ active, payload }) => {
                      ...
                      return (
                        <div className="rounded-md border border-border bg-popover px-3 py-2 shadow-sm">
                          <div className="text-[12px] font-medium text-popover-foreground">
                            {d.label}
                          </div>
                          <div className="text-[10px] font-mono text-muted-foreground">{d.feature}</div>
                          <div className="mt-1 text-[12px] text-popover-foreground">
        ...
        <Card className="bg-card border-border h-fit">
          ...
          <CardContent className="px-4 pb-4">
            ...
            <Collapsible open={advancedOpen} onOpenChange={setAdvancedOpen} className="mt-3">
              <CollapsibleTrigger className="flex items-center gap-1 text-[11px] text-muted-foreground hover:text-card-foreground transition-colors">
                <ChevronDown
              ...
              <CollapsibleContent className="mt-2">
                <div className="flex flex-col gap-0 border-t border-border/40 pt-1">
