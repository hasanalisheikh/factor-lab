...
import { computeDrawdownSeries, getWarmupPointCount, makePolylineShared } from "./charts";
import {
  escapeHtml,
  fmtCostDrag,
  fmtMoney,
...
import { ML_STRATEGIES, PERIODS_PER_YEAR, STRATEGY_LABELS, type RunMetadataView } from "./metadata";
